...
from towers.archerTower import ArcherTowerLong, ArcherTowerShort, RangeTower
...
buy_archer = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","8_enemies_1_run_005.png")).convert_alpha(), (75, 75))
buy_archer_2 = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","43.png")).convert_alpha(), (75, 75))
buy_range = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","10.png")).convert_alpha(), (75, 75))
buy_damage = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","38.png")).convert_alpha(), (75, 75))


play_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","startbt.png")).convert_alpha(), (75, 75))
pause_btn = pygame.transform.scale(pygame.image.load(os.path.join("game_assets","pausebt.png")).convert_alpha(), (75, 75))
...
attack_tower_names = ["archer", "archer2","range"]
support_tower_names = ["damage"]
...
class Game:
    def __init__(self, win):
        ...
        self.menu.add_btn(buy_damage, "buy_damage", 300)
    ...
    def run(self):
        ...
        run = True
        ADDMONEY = pygame.USEREVENT
        pygame.time.set_timer(ADDMONEY,10000)
        ...
        while run:
            ...
            if not self.pause:
                ...
                # loop through attack towers
                for tw in self.support_towers:
                    #self.money += tw.support(self.money)
                    self.SUPPORT = True
                    tw.support()
    ...
    def add_tower(self, name):
        ...
        name_list = ["buy_archer", "buy_archer_2", "buy_range", "buy_damage"]
