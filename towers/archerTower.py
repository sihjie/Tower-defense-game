...
class ArcherTowerLong(Tower):
    ...
    def draw(self, win):
        ...
        if self.left == True:
            ...
            add = -archer.get_width() + 37
        win.blit(archer, ((self.x + add), (self.y - archer.get_height()+20)))
...
for x in range(43,49):
    archer_imgs.append(pygame.transform.scale(
        pygame.image.load(os.path.join("game_assets/archer_towers/archer_top_2", str(x) + ".png")).convert_alpha(),
        (120, 120)))
...
for x in range(37, 43):
    archer_imgs2.append(pygame.transform.scale(
        pygame.image.load(os.path.join("game_assets/archer_towers/archer", str(x) + ".png")).convert_alpha(),
        (90, 90)))
...
class RangeTower(Tower):
    ...
    def draw(self, win):
        ...
        archer = self.archer_imgs[self.archer_count // 3]
        win.blit(archer, ((self.x -35), (self.y - archer.get_height()+30)))
